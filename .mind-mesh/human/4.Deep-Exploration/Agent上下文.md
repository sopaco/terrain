...
**模块路径**：`crates/mind-mesh-agent/src/agent_context.rs`
**生成日期**：2026-06-14
**分析置信度**：8/10
...
| 组件/类型 | 文件路径 | 核心职责 |
|---------|---------|---------|
| `AgentContextGenerationResult` | `crates/mind-mesh-agent/src/agent_context.rs:10` | 生成结果（output_path + meta + response_excerpt） |
| `run_agent_context_generation()` | `crates/mind-mesh-agent/src/agent_context.rs:18` | 上下文生成主流程 |
| `agent_context_exists()` | `crates/mind-mesh-agent/src/agent_context.rs:67` | 快捷检查函数 |
