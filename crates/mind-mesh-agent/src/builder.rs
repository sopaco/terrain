...
- agent/repomix.md — Repomix source pack: indexed project source code (generated by repomix-rs)
...
If the pack may be stale, tell the user to use Pack Context in the UI to repack.
...
impl Default for AgentConfig {
    fn default() -> Self {
        Self {
            knowledge_root: KnowledgePaths::default_home(),
            project_cwd: None,
...
pub fn knowledge_root_from_env() -> KnowledgePaths {
    std::env::var("MIND_MESH_KNOWLEDGE_ROOT")
        ...
        .unwrap_or_else(|_| KnowledgePaths::default_home())
}
