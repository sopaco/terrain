...
fn map_core_err(err: mind_mesh_core::CoreError) -> adk_core::AdkError {
...
pub fn list_projects_tool(paths: KnowledgePaths) -> Arc<dyn Tool> {
    Arc::new(
        FunctionTool::new(
            "list_projects",
            "List indexed projects in the MindMesh knowledge base.",
            move |_ctx, _args| {
        ...
        FunctionTool::new(
            ...
            move |ctx, args| {
                ...
                async move {
                    ...
                    let doc = mind_mesh_core::read_doc_at_in_project(
                        &paths,
                        "agent/context.md",
                        Some(&params.project),
                    )
        ...
        FunctionTool::new(
            ...
            move |_ctx, args| {
                ...
                async move {
                    ...
                    mind_mesh_core::read_doc_at_in_project(
                        &paths,
                        &params.path,
