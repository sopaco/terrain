...
enum AssetCommands {
    ...
    /// Register a repository and point knowledge storage to {repo}/.mind-mesh/
    Register {
        repo_path: PathBuf,
        #[arg(long)]
        slug: Option<String>,
    ...
    match cli.command {
        ...
        Commands::Tools { command } => match command {
            ...
            ToolsCommands::PackMeta { project } => {
                ...
                let meta: AgentPackMeta = mind_mesh_core::read_json(&meta_path)
        ...
        Commands::Assets { command } => match command {
            ...
            AssetCommands::Register { repo_path, slug } => {
                ...
                register_project(&slug, &repo)?;
                paths.ensure_project_layout(&slug)?;
                let knowledge_root = mind_mesh_core::knowledge_root_for_repo(&repo_path);
                println!(
