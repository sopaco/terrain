<script lang="ts">
  ...
  const variantClass: Record<Variant, string> = {
    ...
    toolbar:
      "tr-press inline-flex shrink-0 items-center justify-center rounded-lg border border-tr-border-strong px-2.5 py-1.5 text-tr-ink-2 transition-colors hover:bg-tr-elevated hover:text-tr-accent-hover",
  };
